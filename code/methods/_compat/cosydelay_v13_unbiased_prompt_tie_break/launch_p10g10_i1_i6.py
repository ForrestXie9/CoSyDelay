"""Sequentially launch final V13 P10/G10 searches for intersections I1--I6."""
...
def main() -> int:
    ...
    try:
        ...
        for intersection in range(1, 7):
            ...
            started = now()
            status["active_intersection"] = intersection
            status["active_started_utc"] = started
            write(status_path, status)
            with (parent / "run_01.stdout.log").open(
                ...
                completed = subprocess.run(
                    [
                        ...
                        "-m",
                        (
                            "methods.cosydelay_v13_unbiased_prompt_tie_break."
                            "run_p10g10_training"
                        ),
                        "--intersection",
                        str(intersection),
            ...
            if completed.returncode:
                ...
                status["failed_intersection"] = intersection
                write(status_path, status)
