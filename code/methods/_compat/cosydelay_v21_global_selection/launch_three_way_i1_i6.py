...
def main() -> int:
    ...
    search = root / "search"
    run([sys.executable, "-u", "-m", "methods.cosydelay_v21_global_selection.launch_i1_i6",
    ...
    run([sys.executable, "-u", "-m", "methods.cosydelay_v21_global_selection.evaluate_fixed_test",
