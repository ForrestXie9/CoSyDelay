...
from methods.prospective_lbfgsb_jacobian_v1.jacobian_fitter import _penalty, _row_array
...
def fit_lane_parameters_restart_parallel(
    ...
    *, warm_parameters: Optional[Mapping[str, Mapping[str, float]]] = None,
    ...
    """V18-equivalent fit with approaches × restarts scheduled independently."""
