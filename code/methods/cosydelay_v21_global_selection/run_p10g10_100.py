...
def _source() -> str:
    path = (
        ...
        / "cosydelay_v19_accelerated_equivalent"
        / "run_i1_p10g10_100.py"
    )
    source = path.read_text(encoding="utf-8")
    replacements = (
        (
            "from methods.cosydelay_v19_accelerated_equivalent import pairwise_population",
            "from methods.cosydelay_v21_global_selection import global_population as pairwise_population",
        ),
        (
            "from methods.cosydelay_v19_accelerated_equivalent.prompt_audit import audit_v20_prompts",
            "from methods.cosydelay_v21_global_selection.prompt_audit import audit_v21_prompts as audit_v20_prompts",
        ),
        (
            "from methods.cosydelay_v19_accelerated_equivalent import paper_prompt as v20_prompt",
