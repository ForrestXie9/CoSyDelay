...
from methods.cosydelay._internal.training_protocol.contract import V16_CONTRACT
from methods.cosydelay._internal.training_protocol.policy import V16_POLICY
...
def test_contract_validator_rejects_algorithm_drift(monkeypatch):
    import methods.cosydelay._internal.retry_protocol.contract as module
