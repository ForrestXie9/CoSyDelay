...
def main() -> int:
    ...
    search = root / "search"
    run([sys.executable, "-u", "-m", "methods.cosydelay._internal.global_selection.launch_i1_i6",
    ...
    run([sys.executable, "-u", "-m", "methods.cosydelay._internal.global_selection.evaluate_fixed_test",
