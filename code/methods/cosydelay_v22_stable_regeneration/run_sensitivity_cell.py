"""One V22 sensitivity cell: temperature × traffic-principle prompt ablation."""
...
from methods.cosydelay_v22_stable_regeneration import prompt as v22_prompt
...
SENSITIVITY_DIR = (
    ...
    / "15_v22_llm_prompt_temperature_sensitivity"
)
...
def _install_prompt_treatment(instruction_on: bool):
    if instruction_on:
        init_builder = v22_prompt.build_init_prompt
        regen_builder = v22_prompt.build_regeneration_prompt
    else:
...
def main() -> int:
    ...
    run_contract = replace(
        V18_CONTRACT,
        schema_version=15,
        method_id="cosydelay_v22_llm_prompt_temperature_sensitivity",
    ...
    run_policy = replace(
        V18_POLICY,
        method_id="cosydelay_v22_llm_prompt_temperature_sensitivity",
        method_status="reviewer_v22_prompt_temperature_sensitivity_not_main_performance",
        population=SENSITIVITY_POPULATION,
        generations=SENSITIVITY_GENERATIONS,
    ...
    class V22GuardedCandidateFitter(v18_fit_timeout.GuardedCandidateFitter):
    ...
    @contextmanager
    def install_v22_sensitivity_candidate(**kwargs):
    ...
    try:
        ...
        v18_integration.GuardedCandidateFitter = V22GuardedCandidateFitter
        v18_run.install_v18_candidate = install_v22_sensitivity_candidate
    ...
    result.update(
        {
            "status": "complete_v22_instruction_temperature_cell",
            "not_a_main_performance_result": True,
            "reviewer_experiment": "v22_instruction_by_temperature",
            "intersection_id": args.intersection,
            "run_id": args.run_id,
    ...
    print(
        f"V22-sensitivity I{args.intersection} run={args.run_id} "
