# V22 experimental overlay

This directory does not modify V21.  Every outer restart uses the same V21
global-selection P10/G10 search and the same coefficient fitter; only the
...
role-defined ranges are fixed before any V22 search and do not read
