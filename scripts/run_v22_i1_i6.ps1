param(
    ...
    [string]$OutputRoot = "runs\v22_i1_i6"
)
...
foreach ($intersection in $Intersections) {
    ...
    Write-Host "Starting V22 intersection $intersection -> $output"
    ...
    if ($LASTEXITCODE -ne 0) {
        throw "V22 intersection $intersection failed with exit code $LASTEXITCODE"
    }
}
